...
<template>
    <div class="mx-auto max-w-7xl">
        ...
        <div class="relative lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div class="relative mt-12 sm:mx-auto sm:max-w-lg lg:col-span-6 lg:mx-0 lg:mt-8 lg:flex lg:max-w-none lg:items-center">
                ...
                <div class="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-2xl">
                    <img class="w-full rounded-lg" src="https://images.unsplash.com/photo-1607817359832-19a6a93c5f23?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&h=960&q=80" alt="" />
                </div>
            </div>
        </div>
    </div>
